...
for an in _config.analysis:
    ...
    for trig in triggers:
        efficiency_Vtx_strings.append("Eff_trueVtxDist_"+an+"_rec_"+trig+" ' Efficiency of "+trig+" vs nb of interactions ; nb events passing each path ' trueVtxDist_"+an+"_rec_"+trig+" trueVtxDist_"+an+"_rec")

efficiency_strings.extend(efficiency_summary_strings)
efficiency_strings.extend(get_reco_strings(efficiency_strings))
efficiency_strings.extend(efficiency_Vtx_strings)
efficiency_summary_strings.extend(efficiency_Vtx_strings)
